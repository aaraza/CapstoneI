...
stanfordNLP_classifier_path = '/media/justin/Data/Google Drive/Assignments and Projects/Machine Learning/NLP/english.all.3class.distsim.crf.ser.gz'
stanfordNER_jar_path = '/media/justin/Data/Google Drive/Assignments and Projects/Machine Learning/NLP/stanford-ner.jar'
...
# Assign a binary positive or negative value for the sentiment scores from each article.
...
'''
Perform tagging on each article with a part of speech tag to prepare for named entity extraction.
'''
...
'''
Build a part of speech tree for named entity extraction. 
'''
...
def main():
    ...
    st = StanfordNERTagger(stanfordNLP_classifier_path, stanfordNER_jar_path, encoding='utf-8')
